 ...
 */
WaterCanvas.prototype.enableMouseInteraction = function (
  waterModel,
  pixel,
  finger
) {
  var mouseDown = false;
  var canvasHolder = this.documentElement;
  ...
  canvasHolder.addEventListener('mousedown', handleMousedown, false);
  canvasHolder.addEventListener('mouseup', handleMouseup, false);
  canvasHolder.addEventListener('mousemove', handleMousemove, false);
  return () => {
    canvasHolder.removeEventListener('mousedown', handleMousedown);
    canvasHolder.removeEventListener('mouseup', handleMouseup);
